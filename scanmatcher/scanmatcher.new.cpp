...
//   if (m_laserAngles) delete[] m_laserAngles;
// }
//
...
// }
//
// void ScanMatcher::registerScan(ScanMatcherMap& map, const OrientedPoint& p,
//                                const double* readings) {
