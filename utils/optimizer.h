...
struct Optimizer {
  ...
  OrientedPoint gradientDescent(const RangeReading& oldReading, const OrientedPoint& pose,
                                OLocalMap& Map);
...
template <typename Likelihood, typename Map>
OrientedPoint Optimizer<Likelihood, Map>::gradientDescent(const RangeReading& oldReading,
...
template <typename Likelihood, typename Map>
OrientedPoint Optimizer<Likelihood, Map>::gradientDescent(const RangeReading& reading,
