...
class QMapPainter : public QWidget {
 ...
 public:
  ...
  void drawPoints(const Iterator& begin, const Iterator& end, unsigned char r, unsigned char g,
                  unsigned char b);
...
template <typename Iterator>
void QMapPainter::drawPoints(const Iterator& begin, const Iterator& end, unsigned char r,
